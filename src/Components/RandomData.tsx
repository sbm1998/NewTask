...
const RandomData:React.FC<Props>= (props)=>{
    ...
    const {users,getUserData,loadingUser,changeUserSubscriptionPlan,changeAllUsersSubscriptionPlan}=props.UsersStore;
    ...
    return(
        <div>
            <button onClick={() =>{history.push("/form");}}>UserForm</button>
                    ...
                    <tbody>
                        ...
                        {props.UsersStore.users.map((item)=>{
                          return( <tr>
                           ...
                           <td>{item.changingPlan?<div>changing..</div>:item.plan}</td>

                           <button onClick={()=>{changeUserPlan(item.id)}}>Change User Plan</button> 
                           </tr>)
